...
ROWS = [
    ...
    ("kv", "School",   "Bursa Uludağ Üniversitesi"),
    ("kv", "LinkedIn", "linkedin.com/in/caglarsapmaz"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages","Python, JavaScript, C"),
    ("kv", "Frontend", "HTML, CSS, React"),
    ("kv", "Backend",  "Node.js, SQL"),
    ("kv", "Tools",    "Git, GitHub, Linux"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Open source projelere katkı sağlıyor"),
    ("bul", "Animasyonlu GitHub profil README oluşturdu"),
    ("bul", "Sürekli öğrenmeye odaklı"),
]
